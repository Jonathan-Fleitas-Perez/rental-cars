  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          "bg-primary! text-primary-foreground! hover:bg-primary/90 hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground shadow-lg scale-110 z-10",
        ...
        day_range_middle:
          "aria-selected:bg-primary/20! aria-selected:text-primary! rounded-none font-medium",
